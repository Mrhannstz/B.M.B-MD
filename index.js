...
setTimeout(() => {
  async function _0x244966() {
    ...
    const _0x4d610a = {
      ...
      'browser': ["MR-B.M.B-Md", "safari", "1.0.0"],
    ...
    _0x25e00e.ev.on("group-participants.update", async _0x286af2 => {
      ...
      try {
        ...
        _0x4d571f = "https://telegra.ph/file/c66d12099fb7a4f62d70a.g";
      }
      try {
        ...
        if (_0x286af2.action == "add" && (await _0x131f2b(_0x286af2.id, "welcome")) == 'on') {
          ...
          if (_0x286af2.action == "remove" && (await _0x131f2b(_0x286af2.id, "goodbye")) == 'on') {
            let _0x120816 = "Another idiot has just left the group.Anyway we will miss you very much comrade🤝 powered by *MR-B.M.B-MD* \n\n>  *Regards boniee*;\n";
